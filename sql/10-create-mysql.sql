...
create table mwl_item (pk bigint not null auto_increment, accession_no varchar(255) not null, admission_id varchar(255) not null, created_time datetime not null, institution varchar(255) not null, department varchar(255) not null, local_aet varchar(255) not null, modality varchar(255) not null, req_proc_id varchar(255) not null, sps_id varchar(255) not null, sps_start_date varchar(255) not null, sps_start_time varchar(255) not null, sps_status integer not null, study_iuid varchar(255) not null, updated_time datetime not null, version bigint, dicomattrs_fk bigint not null, inst_code_fk bigint, dept_code_fk bigint, accno_issuer_fk bigint, admid_issuer_fk bigint, patient_fk bigint not null, perf_phys_name_fk bigint, primary key (pk));
...
create index UK_gknfxd1vh283cmbg8ymia9ms8 on issuer (entity_id(64));
...
create index UK_9ockpkbetj7a97for0s1jhasi on mwl_item (local_aet(64));
...
create index UK_tlkw80b7pbutfj19vh6et2vs7 on mwl_item (admission_id(64));
create index UK_8qkftk7n30hla3v1frep9vg2q on mwl_item (institution(64));
create index UK_ksy3uy0rvpis1sqqeojlet7lb on mwl_item (department(64));
...
create index UK_b9e2bptvail8xnmb62h30h4d2 on series (sending_aet(64));
create index UK_lnck3a2qjo1vc430n1sy51vbr on series (receiving_aet(64));
create index UK_gxun7s005k8qf7qwhjhkkkkng on series (sending_pres_addr(64));
create index UK_e15a6qnq8jcq931agc2v48nvt on series (receiving_pres_addr(64));
...
create index UK_n5froudmhk14pbhgors43xi68 on study (admission_id(64));
...
alter table mwl_item add constraint FK_9k8x73a91nd9q7ux7h5itkyh5 foreign key (admid_issuer_fk) references issuer (pk);
...
alter table study add constraint FK_9fqno60wc3gr4376ov1xlfme4 foreign key (admid_issuer_fk) references issuer (pk);
